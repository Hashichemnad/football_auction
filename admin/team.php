...
if(isset($_POST['submit'])) {
  ...
  $query="INSERT INTO teams (name, image, captain, manager) " 
  . "VALUES ('$name','$image','$captain','$manager')";
  mysqli_query($connect,$query);
  echo '<script>alert("inserted successfully'.$name.'")</script>';
 }
							...
							<!--/forms-->
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Lassi upload</h3>
																	<div class="form-body">
																		<form action="#" method="post" enctype="multipart/form-data">
																		<div class="form-group"> <label for="exampleInputFile">Logo</label> <input type="file" name="image" id="exampleInputFile"> </div>
																		<div class="form-group"> <label for="exampleInputEmail1">Name</label> <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="team name"> </div> 
																		<div class="form-group"> <label for="exampleInputPassword1">captain</label> <input type="text" name="captain" class="form-control" id="exampleInputPassword1" placeholder="captain"> </div> 
																		<div class="form-group"> <label for="exampleInputEmail1">Manager</label> <input type="text" name="manager" class="form-control" id="exampleInputEmail1" placeholder="Manager"> </div> 
