...
if(isset($_POST['submit'])) {
  ...
  $query="INSERT INTO gallery (name, image) " 
  . "VALUES ('$name','$image')";
													...
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Gallery upload</h3>
																	<div class="form-body">
																		<form action="#" method="post" enctype="multipart/form-data"> <div class="form-group"> <label for="exampleInputEmail1">Name</label> <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="title"> </div> 
