...
$targetfolder = "../video/";
$targetfolder = $targetfolder . basename( $_FILES["video"]["name"]) ;
move_uploaded_file($_FILES["video"]["tmp_name"], $targetfolder);
$file=basename( $_FILES["video"]["name"]);
$query="INSERT INTO video (file) " 
. "VALUES ('$file')";
...
<div class="wthree_agile_admin_info">
							...
							<!--/forms-->
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Gallery upload</h3>
																	<div class="form-body">
																		<form action="#" method="post" enctype="multipart/form-data"> <div class="form-group">  </div> 
																		<div class="form-group"> <label for="exampleInputFile">Video</label> <input type="file" name="video" id="exampleInputFile"> </div>
		...
		<source src="../video/'.$row['file'].'" type="video/mp4">
