  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar absolute transparent" role="banner">
      <div class="py-3">
       ...
       <?php
       $query = "SELECT * FROM teams where tid=".$tid."";  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="row">
          <?php
          $query = "SELECT * FROM players where team=".$tid." order by name asc";  
          $result = mysqli_query($connect, $query);
          while($row = mysqli_fetch_array($result))
          {
          echo'
          <div class="mb-4 mb-lg-0 col-6 col-md-4 col-lg-2 text-center">
          <div class="player mb-5"><a href="profile.php?id='.$row['id'].'">
          <img src="crop/'.$row['image'].'.jpg" alt="Image" class="img-fluid image rounded-circle">
          <h2>'.$row['name'].'</h2></a>
